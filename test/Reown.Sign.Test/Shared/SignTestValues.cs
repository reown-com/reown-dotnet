...
namespace Reown.Sign.Test.Shared;
...
public static class SignTestValues
{
    ...
    public static readonly string[] TestChains = new[]
    {
        TestEthereumChain,
        TestArbitrumChain
    };

    public static readonly string[] TestEvents = new[]
    {
        "chainChanged",
        "accountsChanged"
    };

    public static readonly RequiredNamespaces TestRequiredNamespacees = new()
    {
        {
    ...
    public static readonly RequiredNamespaces TestRequiredNamespaceesV2 = new()
    {
        {
            "eip155", new ProposedNamespace()
            {
    ...
    public static readonly Namespaces TestOptionalNamespaces = new()
    {
        {
