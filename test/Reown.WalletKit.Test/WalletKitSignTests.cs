...
public class WalletKitSignTests : IClassFixture<CryptoWalletFixture>, IAsyncLifetime
{
    ...
    public WalletKitSignTests(CryptoWalletFixture cryptoWalletFixture, ITestOutputHelper testOutputHelper)
    {
